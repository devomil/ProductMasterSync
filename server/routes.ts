...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // All Amazon data must come from authentic SP-API calls only
  ...
  async function getDetailedAsinData(asin: string, productData: any, merchantId: string, marketplaceId: string, matchType: string, confidence: number) {
    try {
      ...
      return {
        asin: asin,
        title: amazonData.title || fullData.title || productData.name,
        brand: amazonData.brand || fullData.brand || productData.manufacturer_name,
        ...
        confidence: amazonData.match_confidence || confidence,
        match_type: amazonData.match_method || matchType,
        ...
        availability_status: amazonData.availability_status,
        prime_eligible: amazonData.prime_eligible,
        buy_box_eligible: amazonData.buy_box_eligible,
        buy_box_price: amazonData.buy_box_price,
        competitive_sellers: amazonData.competitive_sellers,
        fba_fees: amazonData.fba_fees,
        referral_fees: amazonData.referral_fees,
        profit_margin: amazonData.profit_margin,
        sales_velocity: amazonData.sales_velocity,
        inventory_level: amazonData.inventory_level,
        search_terms: amazonData.search_terms || [],
